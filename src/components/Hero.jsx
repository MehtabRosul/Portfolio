      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#00f3a2]'>Mehtab</span>
          </h1>
          
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop AI & ML <br className='sm:block hidden' />
            <span className='text-[#a0f8db]'>for driving transformative advancements, elevating human possibilities.</span>
          </p>
        </div>
        <iframe 
